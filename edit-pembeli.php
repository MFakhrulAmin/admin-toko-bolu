...
if (isset($_POST["UpdatePembeli"])) {
    ...
    //update database
    mysqli_query($dbconnect,"UPDATE pembeli SET nama_pembeli = '$nama', jenis_kelamin = '$gender'
        WHERE id_pembeli = '$id'");
    header("Location: tabel-pembeli.php");
}
$isi_data_pembeli = mysqli_fetch_assoc(mysqli_query($dbconnect, "SELECT * FROM pembeli WHERE id_pembeli = '$id'"));
			...
			<ul class="sidebar-nav" id="sidebar-nav">
				...
				<li class="nav-item">
					...
					<ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
						...
						<li>
							<a href="tabel-pembeli.php" class="active"> <i class="bi bi-circle"></i><span>Pembeli</span> </a>
						</li>
						<li>
			...
			<div class="pagetitle">
				...
				<nav>
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="tabel-pembeli.php">Data Pembeli</a></li>
							...
							<div class="card-body">
                                ...
                                <form method="POST" class="needs-validation" novalidate action="">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="nama" class="form-control" value="<?= $isi_data_pembeli['nama_pembeli']; ?>" required>
                                        </div>
                                    </div>
                                    <fieldset class="row mb-3">
									<legend class="col-form-label col-sm-2 pt-0">Jenis Kelamin</legend>
										<div class="col-sm-10">
											<?php if($isi_data_pembeli['jenis_kelamin'] == 'Laki-laki') { ?>
                                    ...
                                    <div class="col-sm-10">
                                        <button class="btn btn-success" name="UpdatePembeli"><i class="bi bi-check-circle"></i> Update</button>
                                    </div>
                                </form>
